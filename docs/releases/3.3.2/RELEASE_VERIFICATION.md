...
9. отсутствие current-ссылок на `../3.2.4/RELEASE_VERIFICATION.md`;
...
- follow-up test-only consistency commit `e17305f908cc977bde3b313224a0e0128206e314` делает Server static-client test герметичным и сохраняет website fallback, производный от `package.json`.

## Documentation consistency

- security boundary наследуется из [Security Review 3.3.0](../3.3.0/SECURITY_REVIEW.md);
...
- [../README.md](../README.md) является указателем и не дублирует timeline;
...
Release evidence workflow run `30004686716` завершился успешно. Опубликованный tag `v3.3.2` неизменяемо указывает на release commit `82af775fb39515bd219078fec368cc259441c288`; post-release documentation/CI corrections `650f62d5ae537695061922a4ea130d97040922ca` и `e17305f908cc977bde3b313224a0e0128206e314` не перемещают и не пересоздают tag.
