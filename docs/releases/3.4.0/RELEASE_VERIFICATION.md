...
| Field | Value |
|---|---|
| Branch | `release/3.4.0-stable-core-v2` |
| Pull request | `#96` |
...
| Working branch started from verified post-3.3.4 commit | **PASS** | clean branch starts from merge commit `6202bbdf8ff636711d9874452958df5dd40d9656` |
...
1. verified `v3.3.4` source baseline is merged; immutable tag/release/assets remain absent;
