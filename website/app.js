(() => {
  ...
  const dictionary = {
    ru: {
      ...
      membersSecure: "8 участников · secure conversation",
      today: "СЕГОДНЯ",
      mockOne: "Local Server остаётся authority для комнат, ролей и доставки ciphertext.",
      ...
      productLead: "Nexora объединяет messaging, комнаты, медиа, offline-first поведение, эксплуатацию, Trust Core и отдельный Cloud authority без обязательной передачи локальных сообщений в централизованное облако.",
      ...
      trustCardTitle: "Device-scoped secure messaging",
      trustCardText: "Ed25519 identity, verified devices, MLS epochs, replay protection, ciphertext-only persistence и encrypted local state.",
      ...
      mediaTitle: "Validated and encrypted media",
      mediaText: "Resumable uploads, actual MIME detection, SHA-256, safe names, previews, voice playback и AES-256-GCM secure attachments.",
      ...
      archClient: "UI, offline state, device keys, MLS encryption/decryption и verified media preview.",
      archServerTitle: "Локальный источник истины",
      archServer: "Accounts, sessions, rooms, roles, bans, policies, ordering, ciphertext delivery, storage, audit и backup.",
      ...
      matrixClient: "Private MLS state и attachment keys не передаются Local Server.",
      ...
      deliveryTitle: "От composer до verified device.",
      ...
      deliveryTwoTitle: "Encrypt",
      deliveryTwo: "MLS application ciphertext",
      deliveryThreeTitle: "Authorize",
      deliveryThree: "Session, device, membership, epoch",
      deliveryFourTitle: "Persist",
      deliveryFour: "Ciphertext + delivery state",
      deliveryFiveTitle: "Deliver",
      deliveryFive: "Только verified member devices",
      ...
      unclaimed: "unclaimed",
      totalInventory: "общий inventory",
      lifecycleTitle: "Идентичность устройства становится частью доступа.",
      lifeOneTitle: "Identity key",
      lifeOne: "Client создаёт non-extractable Ed25519 identity key.",
      lifeTwoTitle: "Proof of possession",
      lifeTwo: "Registration подтверждает владение private key.",
      lifeThreeTitle: "Verification",
      lifeThree: "Дополнительное устройство получает подписанное подтверждение.",
      lifeFourTitle: "Scoped delivery",
      lifeFour: "Ciphertext доставляется конкретным verified devices.",
      lifeFiveTitle: "Revocation",
      lifeFive: "Отзыв немедленно отключает secure socket и очищает local state.",
      ...
      docSecurity: "Threat model, Trust/MLS boundary и residual risks.",
    ...
    en: {
      ...
      membersSecure: "8 members · secure conversation",
      today: "TODAY",
      mockOne: "Local Server remains authoritative for rooms, roles and ciphertext delivery.",
      ...
      productLead: "Nexora combines messaging, rooms, media, offline-first behaviour, operations, Trust Core and an isolated Cloud authority without requiring local messages to move into a central cloud.",
      ...
      trustCardTitle: "Device-scoped secure messaging",
      trustCardText: "Ed25519 identity, verified devices, MLS epochs, replay protection, ciphertext-only persistence and encrypted local state.",
      adminTitle: "Server-side policies",
      adminText: "Owner, moderator, member, custom roles, bans, invites, join requests, read-only, slow mode and media restrictions.",
      mediaTitle: "Validated and encrypted media",
      mediaText: "Resumable uploads, actual MIME detection, SHA-256, safe names, previews, voice playback and AES-256-GCM secure attachments.",
      ...
      archClient: "UI, offline state, device keys, MLS encryption/decryption and verified media preview.",
      archServerTitle: "Local source of truth",
      archServer: "Accounts, sessions, rooms, roles, bans, policies, ordering, ciphertext delivery, storage, audit and backup.",
      ...
      lifeTwoTitle: "Proof of possession",
      lifeTwo: "Registration proves possession of the private key.",
      lifeThreeTitle: "Verification",
      lifeThree: "An additional device receives signed approval.",
      lifeFourTitle: "Scoped delivery",
      lifeFour: "Ciphertext is delivered to specific verified devices.",
      lifeFiveTitle: "Revocation",
