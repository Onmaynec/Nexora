...
const UNSAFE_SVG = /<\s*(?:script|foreignObject|iframe|object|embed)\b|<!\s*(?:DOCTYPE|ENTITY)\b|\bon[a-z]+\s*=|\b(?:href|xlink:href)\s*=\s*["']?\s*(?:javascript:|data:|https?:|\/\/)|url\s*\(\s*["']?\s*(?:javascript:|data:|https?:|\/\/)/i;
