...
Релиз завершён только после успешных CI jobs, публикации исправленного immutable tag `v3.3.2`, smoke-проверки Client/Server/Android/PWA и появления immutable evidence `release-evidence/v3.3.2.json`.
